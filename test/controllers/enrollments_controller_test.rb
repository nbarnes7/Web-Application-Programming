...
class EnrollmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post enrollments_url, params: { enrollment: { section_id: @enrollment.section_id, student_id: @enrollment.student_id } }
    end
  ...
  test "should update enrollment" do
    patch enrollment_url(@enrollment), params: { enrollment: { section_id: @enrollment.section_id, student_id: @enrollment.student_id } }
